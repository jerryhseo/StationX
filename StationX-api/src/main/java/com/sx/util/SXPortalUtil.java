...
public class SXPortalUtil {
	...
	public static JSONObject createPortletInstanceId ( PortletRequest portletRequest, String portletName )
	...
	public static final long getDataFileFolderId (
				PortletRequest portletRequest, long repositoryId, long parentFoderId, String dataTypeName,
				String dataTypeVersion, String termName, String termVersion, long dataId
		...
		long folderId =
					getFolderId ( portletRequest, repositoryId, dataTypeVersionFolderId, String.valueOf ( dataId ) );

		return folderId;
	}

	@Deprecated
	private static final long getFolderId (
				PortletRequest portletRequest, long repositoryId, long parentFolderId, String folderName
	) throws PortalException {
		Folder folder = null;
		try {
